...
from ldm_patched.modules import utils, model_management, attention
...
class AttentionSharingUnit(torch.nn.Module):
    ...
    def forward(self, h, context=None, value=None, transformer_options={}):
        ...
        for f in range(self.frames):
            ...
            o = attention.optimized_attention(q, k, v, self.heads)
        ...
        x = attention.optimized_attention(q, k, v, self.heads)
        x = self.temporal_o(x)
